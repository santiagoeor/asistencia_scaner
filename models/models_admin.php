...
class DBConfig {
	...
	//function conexion($host='localhost',$user='id19468374_root',$pass='lh4%k_AIk5=z',$db='id19468374_qrs'){
	function conexion($host='localhost',$user='root',$pass='123456789',$db='db_scaner'){
