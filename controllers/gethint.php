...
//$hint = "";
//servidor local
$con = mysqli_connect('localhost','root','12345678','db_scaner');
//Servidor web
...
$result=mysqli_query($con,"SELECT * FROM registros WHERE nombre='$q'");
$rowcount=mysqli_num_rows($result);
if($rowcount==0){
$ret=mysqli_query($con,"INSERT INTO `registros`(nombre,fechayhora) VALUES ('$q',NOW())");
if($ret)
{
