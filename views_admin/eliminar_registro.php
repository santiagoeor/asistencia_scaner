        ...
        <div class="content-wrapper">
            ...
            <section class="content-header" id="fondo">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 align="right">Eliminar Producto</h1>
                        </div>
                        <div class="col-sm-6">
...
if(isset($_GET["cp"])){//URL PERFECTA
  ...
  $persona = array();
  $persona = $objDBC->personasPorId($_GET["cp"]);

  if($persona){ //VERIFICA QUE LA INFORMACION EXISTE
...
?>
            ...
            if(isset($_POST["txt_codprod"])){//verificar la existencia de envio de datos
              ...
              $ejecucion = $objDBO->Operaciones("DELETE FROM registros
                                                 WHERE id=$codp ");

              if($ejecucion){ // Todo se ejecuto correctamente
                echo "<div class='alert alert-success'>
                         Persona Eliminada con exito<br>                         
                      </div>
                      <a href='scanerlistado.php' class='btn btn-default'>Ver Listado </a>";
            ...
            ?>
                            ...
                            <form role="form" name="frm_prods" id="frm_prods" method="POST"
                                action="eliminar_registro.php?cp=<?php echo $_GET['cp']; ?>"
                                enctype="multipart/form-data">

                                <div class="card-body">
                                    Usted va a eliminar la asistencia de
                                    <b><?php echo $persona[0]['nombre']; ?></b><br>
