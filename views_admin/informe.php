...
<body>
  ...
  if(isset($_POST["txtBuscar"])){ //se filtro algo
    $prods = $objDB->personasPorIdCoinc($_POST["txtBuscar"]); //filtramos coincidencia
  }else{
    $prods = $objDB->listadopersonas(); //traemos todo
  }
            ...
            <section class="content">
                    ...
                    <div class="col-md-12">
                        ...
                        <form name="frm_filtro" id="frm_filtro" method="post" action="informe.php">
                            <div class="card">
                                ...
                                <!-- Para controles de formularios siempre usar etiqueta FORM -->
                                <div class="card-body">
                                    <label for="txtBuscar">Nombre de la persona</label>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header bg-indigo">
                                <h3 class="card-title">Datos de las personas</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body p-0">
                                <?php if($prods){ //verifica si hay registros de datos ?>
                                <a href="#" id="btn_print" class="btn btn-info btn-xs float-right d-print-none"><i
                ...
                echo "<div class='alert alert-secondary'>
                      ...
                      <a href='scanerlistado.php' class='btn btn-info' >Registro</a> 
                      </div>
                      ";
              }
                 ?>
